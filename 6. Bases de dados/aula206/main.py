...
with connection:
    with connection.cursor() as cursor:
        cursor.execute(  
            ...
            'id INT NOT NULL AUTO_INCREMENT, ' # ATENÇÃO SEMPRE DEIXAR UM ESPAÇO EM BRANCO NO FIM DE CADA LINHA SQL
        ...
        cursor.execute(f'TRUNCATE TABLE {TABLE_NAME}')  # apaga tudo na tabela para evitar duplicatas
    connection.commit()

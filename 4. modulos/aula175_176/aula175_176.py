...
'''
print(str_json) # imprime em formato json

filme = json.loads(str_json) # converte o json para um dicionário
...
filme2: Movie = json.loads(str_json) # filme2 é do tipo Movie e herdou todas os seus atributos
print(filme2['title'])

print(json.dumps(filme, ensure_ascii=False, indent=2)) 
#json.dumps remove os acentos do texto, ensure_ascii=False, força a mostrar os acentos, indent é a indentação
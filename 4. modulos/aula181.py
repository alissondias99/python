...
# Obs.: números pseudoaleatórios significa que os números parecem ser aleatórios, mas na verdade não são. Portanto, este módulo não deve ser usado para segurança ou uso criptográfico.
...
# random.seed(0) # todos os valores serão baseabos nesse 0

# random.randrange(início, fim, passo)
#   -> Gera um número inteiro aleatório dentro de um intervalo específico
r_range = random.randrange(10, 20, 2) #gera um número entre 10 e 20 pulando de 2 em dois, logo só gera números pares
#print(r_range)
